...
class familyPics
{
	//pointers
		...
		//update nodes
		// loc variable take title and find the node  
		// data data2 data3 used to  update 
		...
		void search(string title)
		{
			...
			if(temp == NULL)
			{
				cout<<" family category are empty "<<endl;
			}
			else
			{
...
class friendPics
{
		...
		void search(string title)
		{
			...
			if(temp == NULL)
			{
				cout<<"friend Category are empty !!"<<endl;
			}
			else
			{
			while(temp->next!=NULL && temp->title!=title)
...
int main()
{
	...
	do
	{
		...
		case 3:
			...
			break;
		case 4:
			cout<<" 19 : Please Enter 19 to Search for Photos"<<endl;
			cin>>x;
			break;
			cout<<"\n";
		case 5:
			cout<<" 20 : Please Enter 20 to Display All Photos"<<endl;
			cin>>x;
			break;
			cout<<"\n";
			break;
